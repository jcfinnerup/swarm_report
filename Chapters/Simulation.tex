...
\begin{itemize}
\item{\textbf{Gravity} is an essential part of the simulation, as the control algorithm has to be tested in an environment where objects behave with close real-life resemblance} 
...
\item{\textbf{Collisions} are important as well as they are used as a test metric for how well the control algorithms will be doing. They are however not important when happening, as long as they can be detected and noted for the purpose of improving the algorithms}
\item{\textbf{}}
\end{itemize}
