...
Figure \ref{fig:completion_check} shows the part of the simulation model which is responsible for stopping the simulation time when the control problem is solved completely or when the time limit of 500 seconds is reached. 

% Completion check
\begin{figure}[H]
  \centering
  \includegraphics[width=1\columnwidth]{figures/completion_check}
