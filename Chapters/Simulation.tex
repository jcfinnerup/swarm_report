...
\begin{figure}[H]
	...
	\includegraphics[width=1\columnwidth]{figures/3d_platform}
  	\caption{\label{fig:3d_overview}Screenshot from the VRfi3D environment used in the simulation}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=.7\columnwidth]{figures/simulink_gravity_y}
